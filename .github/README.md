...
Gets a value via the current lens, the optional first parameter is either a given root value (for abstract lenses) or the root value that was passed to [`lens`](#lensaroot-a).
